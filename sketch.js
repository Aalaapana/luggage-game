...
function draw() {
  ...
  for(box in boxes){	 
	  boxes[box].display()
	  //console.log(boxes[box].body.position.y)
  ...
  if(rope.rope.bodyA === null && boxes[boxes.length - 1].body.speed < 1 && gameState === 1){	
	console.log(boxes[boxes.length - 1].body.position.y )
	if(boxes[boxes.length - 1].body.position.y > 1100 && boxes.length > 1){
